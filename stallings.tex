...
\begin{proof}
  ...
  \end{align*}
  With this equality (which also appears as \autocite[Lemma~8.2]{km02}), we conclude the proof by stating that $\gen{U}$ has rank at most $k$ if and only if $\delta(G') + 1 \leq k$.
\end{proof}
