\begin{figure}
  \caption{\label{fig:example}%
    A step-by-step execution of Stallings' folding process (read left-to-right, top-to-bottom) on the graph corresponding to the set of words $U$ defined by $U = \{aab, aba^{-1}, ba^{-1}ba\}$ (this example is from \autocite[Figure~4]{km02}).
