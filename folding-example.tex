\begin{figure}
  \caption{\label{fig:example}%
    A step-by-step execution of Stallings' folding process (read from left to right and from top to bottom) on the graph corresponding to the set of words $U$ defined by $U = \{aab^{-1}, aba^{-1}, ba^{-1}ba\}$ (this example is from \autocite[Figure~4]{km02}).
  Each picture shows the pair of edges to be folded in orange and the root node as a large black circle.}
  \begin{center}
    \begin{tabular}{c c}
      \begin{tikzpicture}[->]
